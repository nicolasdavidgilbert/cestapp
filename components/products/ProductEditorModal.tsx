...
type ProductEditorModalProps = {
  ...
  setEditorForm: Dispatch<SetStateAction<EditorForm>>
  savingProduct: boolean
  priceHistory: PriceHistory[]
  editingHistory: Record<string, string>
  setEditingHistory: Dispatch<SetStateAction<Record<string, string>>>
  newHistoryPrice: string
  setNewHistoryPrice: (value: string) => void
