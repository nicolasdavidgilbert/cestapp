...
import type { AppModalProps, ModalHeaderProps } from '@/src/types/ui'
...
export function ModalHeader({
  ...
  return (
    <div className={cn('flex items-center justify-between border-b border-border bg-foreground/[0.02] p-5 sm:p-8', className)}>
      <div className="space-y-0.5 sm:space-y-1">
        <h2 className={cn('text-xl sm:text-2xl font-bold tracking-tight text-foreground leading-tight', titleClassName)}>{title}</h2>
